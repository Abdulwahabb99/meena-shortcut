...
function ComplexProjectCard({ color = "dark", image, title, dateTime = "", description, members = [], dropdown = false }) {
  type DropdownCfg = { action: () => void; menu: React.ReactNode };
  const d = dropdown as false | DropdownCfg;
  const dropdownMenu = d && typeof d === "object" ? d : null;
