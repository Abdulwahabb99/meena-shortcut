...
const StyledAlertRoot = MDAlertRoot as ComponentType<
  Record<string, unknown> & { ownerState: { color: string }; children?: ReactNode }
>;
...
function MDAlert({ color = "info", dismissible = false, children, ...rest }) {
  ...
  const alertTemplate = (mount = true) => (
    <Fade in={mount} timeout={300}>
      <StyledAlertRoot ownerState={{ color }} {...rest}>
